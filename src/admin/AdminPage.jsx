          ...
          <div style={{ marginTop: 20 }}>
            <Card>
              <SectionHeader
                ...
                description="اسحب المقررات بين الفترات يدويًا، ويمكنك قفل الجدول أو تثبيت بعض المقررات حتى لا تتغير لاحقًا، (يمكن استعراض القررات غير المجدولة في أسفل الصفحة)."
              />
