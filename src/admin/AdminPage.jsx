...
const hasImportedSf01 = rows.length > 0 && parsed.missingColumns.length === 0;
...
const generateGeneralSchedule = () => {
  if (!hasImportedSf01) {
    showToast("لم يتم استيراد تقرير SF01", "يرجى استيراد تقرير SF01 الصحيح أولًا قبل محاولة توزيع الدراسات العامة.", "warning");
    return;
  }
...
const generateSpecializedSchedule = () => {
  if (!hasImportedSf01) {
    showToast("لم يتم استيراد تقرير SF01", "يرجى استيراد تقرير SF01 الصحيح أولًا قبل محاولة توزيع مقررات التخصص.", "warning");
    return;
  }
  ...
  إضافة مقرر آخر
            ...
            <div style={{ marginTop: 18, border: `1px solid ${COLORS.border}`, borderRadius: 22, padding: 16, background: "#F8FEFE" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
                ...
                <button type="button" onClick={() => addHallConstraintCourseToList(selectedHallConstraintCourseKey)} style={cardButtonStyle({ disabled: !selectedHallConstraintCourseKey })} disabled={!selectedHallConstraintCourseKey}>إضافة المقرر</button>
              </div>
      ...
      <div style={{ display: "grid", gap: 14, marginTop: 18 }}>
        ...
        <div style={{ border: `1px solid ${COLORS.border}`, borderRadius: 18, padding: 14, marginTop: 14, background: "#F8FEFE" }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
            ...
            <button type="button" onClick={() => addInvigilatorConstraintCourseToList(selectedInvigilatorConstraintCourseKey)} style={cardButtonStyle({ disabled: !selectedInvigilatorConstraintCourseKey })} disabled={!selectedInvigilatorConstraintCourseKey}>إضافة المقرر</button>
          </div>
