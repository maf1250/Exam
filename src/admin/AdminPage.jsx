        ...
        >
          ...
          >
            ...
            <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
              ...
              <HintIcon text="عند التفعيل، سيُمنع مدرب المقرر من المراقبة في نفس فترة اختبار مقرره، حتى لو كان هناك أكثر من مقرر في الفترة نفسها، لإتاحة التجول والمتابعة بين القاعات. تفعيل هذا الخيار قد يخل بعدالة التوزيع بشكل طفيف." />
            </span>
          </label>
        </div>
      </div>
