...
*/}
      ...
      >
        ...
        <div style={{ lineHeight: 1.9, width: "100%" }}>
          ...
          <div> بعد الانتهاء من الجدولة، يمكن للزميل نشر البيانات مباشرة لبوابة المتدربين عبر زر النشر الآلي، حيث تتم العملية بشكل فوري، ولحذف بيانات البوابة بعد الانتهاء من الاختبارات، يمكن كتابة اسم الوحدة بدون رفع التقرير ثم الضغط على زر النشر.
           </div>
        {/*
          <div style={{ marginTop: 12 }}>
            <select
