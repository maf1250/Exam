...
*/}
  ...
  <span style={{marginInlineStart: 6, color: COLORS.warning}}>
      ولحذف بيانات البوابة بعد الانتهاء من الاختبارات، يجب حذف البيانات المحلية، ثم كتابة اسم الوحدة في صفحة الخصائص العامة بدون رفع التقرير ثم الضغط على زر النشر (نوصي بحفظ نسخة محلية لاستيرادها عند الحاجة)
  </span></div>
        {/*
          <div style={{ marginTop: 12 }}>
            <select
